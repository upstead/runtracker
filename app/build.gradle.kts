...
if (!hasReleaseSigning) {
    logger.warn(
        "Release signing is not fully configured. Set RELEASE_STORE_FILE, RELEASE_STORE_PASSWORD, RELEASE_KEY_ALIAS, RELEASE_KEY_PASSWORD in local.properties or env vars."
    )
}
